...
export class PcpanelMiniComponent extends PcpanelKnobDeviceBase {
  protected readonly defaultColor = '#ffc940';
  protected readonly lightingVariant: LightingVariant = 'knob';

  protected readonly knobRingPath = KNOB_RING_PATH;

...
public class PCPanelRGBUI extends Device {
    ...
    public PCPanelRGBUI(FxHelper fxHelper, InputInterpreter inputInterpreter, SaveService saveService, OutputInterpreter outputInterpreter, IconService iconService, Event<Object> eventPublisher, OverrideColorService overrideColorService,

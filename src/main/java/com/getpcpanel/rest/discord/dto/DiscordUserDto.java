 ...
 * channel you are currently in ({@code inVoice = true}) with the persisted "seen users" roster and your
 * Discord friends, so a username is pickable even when you're not in a call.
 *
